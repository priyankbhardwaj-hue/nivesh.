...
const MutualFunds: React.FC = () => {
    ...
    const fallbackStats = [
        ...
        { number: '58,847', description: 'Customers spread over 3,000 pincodes' },
        { number: '49,10,298', description: 'Transactions Executed' },
        { number: 'Rs. 6,523', description: 'Crore- Transaction Value' },
    ];
                                                        ...
                                                        {categoryList.map((categoryItem, fundIndex) => (
                                                            <button
                                                                ...
                                                                disabled={
                                                                    ...
                                                                    || (!categoryItem.id && (!categoryItem.sebi_category_id || !categoryItem.sebi_sub_category_id))
                                                                }
                                    ...
                                    >
                                        ...
                                        {openFaqs[index] && (
                                            <div className="px-4 md:px-5 lg:px-6 pb-4 md:pb-5 lg:pb-6 pt-0">
                                                <div className="text-xs sm:text-sm md:text-base text-neutral-700 leading-relaxed prose prose-sm max-w-none" dangerouslySetInnerHTML={{ __html: faq.answer }} />
                                            </div>
                                        )}
                                    </div>
                                ))}
