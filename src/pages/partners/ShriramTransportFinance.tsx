...
import Partner4Logo from '../../components/about/images/partner4.svg';
...
const ShriramTransportFinance: React.FC = () => {
    useEffect(() => {
        window.scrollTo(0, 0);
    }, []);
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <section className="py-12 md:py-20 bg-gradient-to-br from-neutral-50 to-white">
                <div className="container-custom">
                    <nav className="flex items-center space-x-2 text-sm mb-6">
                        ...
                        <span className="text-neutral-400">/</span>
                        <span className="text-neutral-500">Shriram Transport Finance Company Ltd.</span>
                    </nav>
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mt-16">
                        ...
                        <div>
                            ...
                            <p className="text-base md:text-lg text-neutral-600 leading-relaxed mb-8">
                                Shriram Transport Finance Limited is one of India's leading commercial vehicle finance companies, offering secure Fixed Deposit schemes with attractive interest rates. With decades of experience in the financial services sector, the company provides reliable investment opportunities backed by strong financial fundamentals.
                            </p>
                            <div className="flex flex-wrap gap-4">
                                ...
                                <Button
                                    variant="outline"
                                    size="lg"
                                    onClick={() => window.open('https://nivesh.com/en/fixed-deposit/shriram-transport-finance-company-ltd', '_blank')}
                                >
                                    Learn More
                                </Button>
                            </div>
                        ...
                        <div className="flex items-center justify-center">
                            <div className="bg-white rounded-2xl p-8 shadow-lg border border-neutral-100 max-w-md w-full">
                                <img
                                    src={Partner4Logo}
                                    alt="Shriram Transport Finance Limited"
                        ...
                        {[
                            {
                                ...
                                description: 'Shriram Transport Finance Limited Fixed Deposits are backed by the company\'s strong financial position and decades of experience in the financial services sector. The company maintains high credit ratings, ensuring the safety and security of your investments with reliable returns.',
                                icon: (
                            ...
                            },
                            {
                                ...
                                description: 'Shriram Transport Finance offers competitive interest rates on Fixed Deposits that provide attractive returns. The rates are designed to help investors grow their wealth while maintaining the security of their capital. Senior citizens may be eligible for additional interest rate benefits.',
                                icon: (
                                    <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            },
                            {
                                ...
                                description: 'Shriram Transport Finance provides flexibility with premature withdrawal facilities. Investors can withdraw their Fixed Deposits before maturity if needed, subject to applicable terms and conditions. This ensures liquidity while maintaining investment security.',
                                icon: (
                                    <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                    </svg>
            ...
            {/* Why Shriram Transport Finance FD is the Right Choice? */}
            ...
            {/* About Shriram Transport Finance Section */}
                ...
                <div className="container-custom">
                    ...
                    <div className="max-w-4xl mx-auto">
                        <p className="text-base md:text-lg text-white leading-relaxed text-center">
                            Shriram Transport Finance Limited is one of India's leading commercial vehicle finance companies, with a strong presence in the commercial vehicle financing sector. The company offers Fixed Deposit schemes that provide secure investment opportunities with competitive interest rates. With decades of experience and a robust financial foundation, Shriram Transport Finance ensures reliable returns and financial security for its investors.
                        </p>
                    </div>
                </div>
            </section>
...
export default ShriramTransportFinance;
