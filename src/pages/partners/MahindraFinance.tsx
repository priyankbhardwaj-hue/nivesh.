...
import Partner6Logo from '../../components/about/images/partner6.svg';
...
const MahindraFinance: React.FC = () => {
    useEffect(() => {
        window.scrollTo(0, 0);
    }, []);
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <section className="py-12 md:py-20 bg-gradient-to-br from-neutral-50 to-white">
                <div className="container-custom">
                    <nav className="flex items-center space-x-2 text-sm mb-6">
                        ...
                        <span className="text-neutral-400">/</span>
                        <span className="text-neutral-500">Mahindra Finance Limited</span>
                    </nav>
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mt-16">
                        ...
                        <div>
                            ...
                            <p className="text-base md:text-lg text-neutral-600 leading-relaxed mb-8">
                                Mahindra Finance Limited is a leading non-banking financial company, offering secure Fixed Deposit schemes with competitive interest rates. Backed by the Mahindra Group's strong financial foundation and decades of experience, the company provides reliable investment opportunities with attractive returns and flexible tenure options.
                            </p>
                            <div className="flex flex-wrap gap-4">
                                ...
                                <Button
                                    variant="outline"
                                    size="lg"
                                    onClick={() => window.open('https://nivesh.com/en/fixed-deposit/mahindra-finance-limited/', '_blank')}
                                >
                                    Learn More
                                </Button>
                            </div>
                        ...
                        {[
                            {
                                ...
                                description: 'Mahindra Finance Limited Fixed Deposits are backed by the Mahindra Group\'s strong financial foundation and high credit ratings. The company\'s robust risk management practices and commitment to financial security ensure the safety of your investments with reliable returns.',
                                icon: (
                            ...
                            },
                            {
                                ...
                                description: 'Mahindra Finance offers competitive interest rates on Fixed Deposits that provide attractive returns for investors. The rates are designed to help grow your wealth while maintaining capital security. Senior citizens may be eligible for additional interest rate benefits.',
                                icon: (
                                    <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            },
                            {
                                ...
                                description: 'Mahindra Finance provides flexibility with premature withdrawal options for Fixed Deposits. Investors can withdraw their deposits before maturity if needed, subject to applicable terms and conditions, ensuring liquidity while maintaining investment security.',
                                icon: (
                                    <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                    </svg>
            ...
            {/* Why Mahindra Finance FD is the Right Choice? */}
            ...
            <section className="py-12 md:py-20 bg-white">
                <div className="container-custom">
                    <h2 className="text-2xl md:text-4xl font-bold text-[#243062] mb-12 text-center">
                        Who Can Invest in Mahindra Finance FD?
                    </h2>
            ...
            {/* About Mahindra Finance Section */}
            <section className="py-12 md:py-20 bg-gradient-to-br from-red-600 via-red-700 to-red-800">
                <div className="container-custom">
                    <h2 className="text-2xl md:text-4xl font-bold text-white mb-8 text-center">
                        About Mahindra Finance Limited
                    </h2>
                    <div className="max-w-4xl mx-auto">
                        <p className="text-base md:text-lg text-white leading-relaxed text-center">
                            Mahindra Finance Limited is a leading non-banking financial company (NBFC) and part of the Mahindra Group, one of India's largest and most respected business conglomerates. The company specializes in providing financial services including Fixed Deposits, vehicle finance, and rural finance solutions. With a strong presence across India and decades of experience, Mahindra Finance offers secure investment opportunities backed by the Mahindra Group's legacy of trust, financial strength, and commitment to customer satisfaction.
                        </p>
                    </div>
                </div>
            </section>
...
export default MahindraFinance;
