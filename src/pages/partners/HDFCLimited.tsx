...
import Partner2Logo from '../../components/about/images/partner2.svg';
...
const HDFCLimited: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <section className="py-12 md:py-20 bg-gradient-to-br from-neutral-50 to-white">
                <div className="container-custom">
                    <nav className="flex items-center space-x-2 text-sm mb-6">
                        ...
                        <span className="text-neutral-400">/</span>
                        <span className="text-neutral-500">HDFC Ltd.</span>
                    </nav>
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mt-16">
                        ...
                        <div>
                            ...
                            <p className="text-base md:text-lg text-neutral-600 leading-relaxed mb-8">
                                HDFC Limited is one of India's premier housing finance companies with over four decades of experience. Known for its AAA rating from CRISIL and ICRA, HDFC offers secure and attractive Fixed Deposit schemes with competitive interest rates and flexible tenure options.
                            </p>
                            <div className="flex flex-wrap gap-4">
                                ...
                                <Button
                                    variant="outline"
                                    size="lg"
                                    onClick={() => window.open('https://nivesh.com/en/fixed-deposit/hdfc-ltd', '_blank')}
                                >
                                    Learn More
                                </Button>
                            </div>
                        ...
                        {[
                            {
                                ...
                                description: 'HDFC Limited Fixed Deposits have received AAA rating by CRISIL and ICRA, indicating the highest safety standards. This rating reflects the company\'s strong financial position and commitment to security, making it one of the safest investment options for Fixed Deposits.',
                                icon: (
                            ...
                            },
                            {
                                ...
                                description: 'HDFC Limited offers competitive interest rates that are at par with industry standards. Senior citizens enjoy an additional 0.25% to 0.50% interest rate on Fixed Deposits. Special tenure schemes like 35-month and 55-month deposits offer even higher returns up to 7.20% and 7.25% respectively.',
                                icon: (
                                    <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            },
                            {
                                ...
                                description: 'HDFC Limited offers flexible deposit tenures ranging from 12 months to 120 months, allowing investors to choose a period that best suits their financial goals. The company also provides special tenure fixed deposit schemes with attractive rates for specific periods like 35 months and 55 months.',
                                icon: (
                                    <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {/* Why HDFC Limited FD is the Right Choice? */}
            ...
            <section className="py-12 md:py-20 bg-white">
                <div className="container-custom">
                    <h2 className="text-2xl md:text-4xl font-bold text-[#243062] mb-12 text-center">
                        Who Can Invest in HDFC Limited FD?
                    </h2>
                ...
                <div className="container-custom">
                    ...
                    <div className="max-w-4xl mx-auto">
                        <p className="text-base md:text-lg text-white leading-relaxed text-center">
                            HDFC Limited (Housing Development Finance Corporation) is India's leading housing finance company, established in 1977. With over four decades of experience, HDFC has been instrumental in making homeownership a reality for millions of Indians. The company offers a comprehensive range of financial products including Fixed Deposits, Home Loans, and other housing finance solutions. HDFC's Fixed Deposits are backed by AAA ratings from CRISIL and ICRA, ensuring the highest level of safety and security for investors.
                        </p>
                    </div>
                </div>
            </section>
