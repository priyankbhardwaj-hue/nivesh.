...
import Partner5Logo from '../../components/about/images/partner5.svg';
...
const BajajFinance: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <section className="py-12 md:py-20 bg-gradient-to-br from-neutral-50 to-white">
                <div className="container-custom">
                    <nav className="flex items-center space-x-2 text-sm mb-6">
                        ...
                        <span className="text-neutral-400">/</span>
                        <span className="text-neutral-500">Bajaj Finance Limited</span>
                    </nav>
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mt-16">
                        ...
                        <div>
                            ...
                            <p className="text-base md:text-lg text-neutral-600 leading-relaxed mb-8">
                                Bajaj Finance Limited is one of India's leading non-banking financial companies, offering secure Fixed Deposit schemes with attractive interest rates. With a strong track record and high credit ratings, Bajaj Finance provides reliable investment opportunities backed by the Bajaj Group's legacy of trust and financial excellence.
                            </p>
                            <div className="flex flex-wrap gap-4">
                                ...
                                <Button
                                    variant="outline"
                                    size="lg"
                                    onClick={() => window.open('https://nivesh.com/en/fixed-deposit/bajaj-finance-ltd', '_blank')}
                                >
                                    Learn More
                                </Button>
                            </div>
                        ...
                        {[
                            {
                                ...
                                description: 'Bajaj Finance Limited Fixed Deposits are backed by high credit ratings from leading rating agencies, reflecting the company\'s strong financial position and commitment to security. The company\'s robust risk management practices ensure the safety of your investments.',
                                icon: (
                            ...
                            },
                            {
                                ...
                                description: 'Bajaj Finance offers competitive interest rates on Fixed Deposits that help investors grow their wealth effectively. The rates are designed to provide attractive returns while maintaining capital security. Senior citizens may enjoy additional interest rate benefits.',
                                icon: (
                                    <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            },
                            {
                                ...
                                description: 'Bajaj Finance provides flexibility with premature withdrawal options for Fixed Deposits. Investors can withdraw their deposits before maturity if needed, subject to applicable terms and conditions, ensuring liquidity while maintaining investment security.',
                                icon: (
                                    <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                    </svg>
            ...
            {/* Why Bajaj Finance FD is the Right Choice? */}
                ...
                <div className="container-custom">
                    ...
                    <div className="max-w-4xl mx-auto">
                        <p className="text-base md:text-lg text-white leading-relaxed text-center">
                            Bajaj Finance Limited is one of India's leading non-banking financial companies (NBFCs), part of the Bajaj Group. The company offers a wide range of financial products and services including Fixed Deposits, consumer finance, and business loans. With a strong track record of growth and high credit ratings, Bajaj Finance provides secure and attractive investment opportunities backed by the Bajaj Group's legacy of trust and financial excellence spanning over decades.
                        </p>
                    </div>
                </div>
            </section>
